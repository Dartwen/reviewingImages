...
//при клике на berger. показываем все меню
getGlobalVar('burger').addEventListener('click', showMenu);

//при клике на хосле создаем форму комментариев
...
checkurlId(paramId); // Получаем из ссылки параметр id

// для каждого каждого элемента с классом '.menu__color', если элемент выбран  (checked), получим цвет
